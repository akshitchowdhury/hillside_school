  ...
  return (
    ...
    >
      ...
      <motion.section className="tc-padding o-featured-courses p-7 lg:p-24" variants={fadeUpVariants}>
        <div className="container mx-auto my-3 md:my-24">
          {/* Main Heading */}
          <motion.div className="main-heading-holder text-center mb-10" variants={fadeUpVariants}>
            <div className="main-heading text-gray-600">
              <motion.h2 className="text-3xl lg:text-5xl font-serif text-amber-400" variants={fadeUpVariants}>
                Bethel English High School
              </motion.h2>
              <motion.span className="text-6xl" variants={fadeUpVariants}>B</motion.span>
              <motion.span className="sperater flex justify-center items-center mt-4" variants={fadeUpVariants}>
                <i className="w-4 h-4 border-t border-l border-gray-500 rotate-45"></i>
                <i className="w-4 h-4 border-t border-l border-gray-500 rotate-45 mx-2 active"></i>
                <i className="w-4 h-4 border-t border-l border-gray-500 rotate-45"></i>
              </motion.span>
              ...
              {/* First Paragraph */}
              <motion.p className="mt-6 text-left text-base leading-7" variants={fadeUpVariants}>
                <span className="text-3xl font-semibold text-amber-400">
                  Bethel English High School
                </span>{" "}
                was established with the mission of providing high-quality
              ...
              {/* Second Paragraph with Image on the Left */}
              <motion.div className="flex flex-col md:flex-row space-x-3 items-center mt-6 text-base leading-7" variants={fadeUpVariants}>
                <motion.div className="w-full md:w-[700px] mb-4 md:mb-0 md:mr-6" variants={fadeUpVariants}>
                  <img
                    src={eca}
                    alt="Bethel School Campus"
                    className="rounded-lg shadow-lg w-full object-cover"
                ...
                <motion.p className="w-full md:w-3/4 text-justify" variants={fadeUpVariants}>
                Bethel English High School emphasizes a <span className="text-lg font-semibold text-amber-400"> strong foundation in
                  both academic and extracurricular activities </span>. Our curriculum
                   is designed to cater to the overall development of each
                   student, ensuring that they are well-prepared for future
              ...
              {/* Third Paragraph with Image on the Right */}
              <motion.div className="flex flex-col md:flex-row-reverse items-center mt-6 text-base leading-7" variants={fadeUpVariants}>
                <motion.div className="w-full md:w-[400px]  mb-4 md:mb-0 md:ml-6" variants={fadeUpVariants}>
                  <img
                    src={sports}
                    alt="Bethel School Activities"
                ...
                <motion.p className="w-full md:w-2/3 text-justify" variants={fadeUpVariants}>
