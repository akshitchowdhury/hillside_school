...
const VisionMission = () => {
  return (
    ...
    >
      <motion.div variants={fadeInUp} className="flex flex-col lg:flex-row items-center lg:items-start bg-white p-4 lg:p-8">
        {/* Image Section */}
        ...
        {/* Text Section */}
        <motion.div variants={fadeInUp} className="w-full text-justify lg:w-1/2 lg:pl-8 mt-6 lg:mt-0">
      ...
      <motion.div variants={fadeInUp} className="mx-auto py-12 px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-1 gap-8">

          {/* Vision Section */}
          <motion.div variants={fadeInUp} className="flex flex-col-reverse md:flex-row items-center h-full">
            {/* Vision Card */}
            <motion.div variants={fadeInUp} className="bg-amber-400 shadow-lg rounded-none p-6 flex-1 flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-xl duration-300 w-full h-full">
            ...
            {/* Vision Image */}
            <motion.div variants={fadeInUp} className="w-full h-full md:h-[300px] md:w-[700px]">
              <img src={vision} alt="Vision Image" className="object-cover object-top rounded-none w-full h-full" />
            </motion.div>
          </motion.div>

          {/* Mission Section */}
          <motion.div variants={fadeInUp} className="flex flex-col md:flex-row items-center h-full">
            {/* Mission Image */}
            <motion.div variants={fadeInUp} className="w-full h-full md:h-[300px] md:w-[500px]">
              <img src={mission} alt="Mission Image" className="object-cover rounded-none w-full h-full" />
            </motion.div>
            {/* Mission Card */}
            <motion.div variants={fadeInUp} className="bg-gray-950 shadow-lg rounded-none p-6 flex-1 flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-xl duration-300 w-full h-full">
