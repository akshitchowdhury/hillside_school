...
const ResearchText = () => {
  return (
    <div className=" absolute px-2 -my-[70%] lg:-my-[0%] md:-my-[0%] md:labsolute md:top-0
     lg:absolute lg:right-30 lg:top-[200px]">
      <div className="text-left px-4 md:mx-[30%] lg:w-[600px]">
    
    
        <h1 className="text-4xl px-4 md:w-[600px] text-white font-semibold mb-2 md:text-5xl lg:text-5xl">
        Primary Education at  <span className="md:text-7xl text-white">BETHEL ENGLISH HIGH SCHOOL</span>
</h1>
